...
This plot shows that as your arm gets stronger, the simulation goes higher.
...
```
This correlation shows that it is positive. 
...
The p-value for the intercept and ... are ....
...
This plot shows a steady flow of SIMS and GRIP goes higher
